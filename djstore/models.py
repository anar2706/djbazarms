...
class Product(models.Model):
    ...
    img = models.ImageField(upload_to='product',verbose_name=_("Şəkil"))
...
class Topproduct(models.Model):
    ...
    img = models.ImageField(upload_to='topproducts',verbose_name="Şəkil")
...
class Banertop(models.Model): 
    banner_top = models.ImageField(upload_to='banerstop')



class Banerleft(models.Model):
    banner_left = models.ImageField(upload_to='bannersleft')



class Banerright(models.Model):
    banner_right = models.ImageField(upload_to='bannersright')
