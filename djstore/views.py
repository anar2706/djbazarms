...
class HomeView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        if cat:
            context['topproducts'] = Topproduct.objects.filter(
                Q(category__translations__title__icontains=cat)
            )
...
class ProductCreate(CreateView):
    ...
    def form_valid(self, form):
        subject, from_email, to = 'DJ BAZAR', 'djbazaraz@gmail.com', 'djbazaraz@gmail.com'
        text_content = 'DJ BAZAR'
        html_content = '<h1>User mehsul elave edib.</h1><br><h4>Admin Panele Daxil olun</h4><h3><a href="http://djbazar.az/az/admin/djstore/product/">Click</a></h3>'
...
def contact_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            from_email = 'djbazaraz@gmail.com'
            to = 'djbazaraz@gmail.com'
